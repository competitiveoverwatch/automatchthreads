...
class Pasta():
    ...
    def event_pasta(cls, event):
        ...
        try:
            ...
            for match in event['schedule']:
                ...
                sub['time'] = cls.time_from_timestamp(int(match['timestamp']))
            ...
            return 'Sorry, something went wrong. Check https://www.over.gg for information on the matches.'
    ...
    def match_pasta(cls, match):
        ...
        try:
            ...
            return 'Sorry, something went wrong. Check https://www.over.gg for information on the match.'